...
<template>
  <div >
    ...
    <el-table v-loading="loading" :data="list" style="width: 100%" @row-click="clickRow" border stripe ref="moviesTable">
      ...
      <el-table-column width="150px" prop="updateTime" label="更新日期" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    refresh() {
      ...
      deviceNum: this.filters.deviceNum ,currentPage: this.currentPage, status: 2 });
